...
**[ivoryriggerwrath/discord-fix-19.9](https://github.com/ivoryriggerwrath/discord-fix-19.9)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/ivoryriggerwrath/discord-fix-19.9/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `ivoryriggerwrath/discord-fix-19.9`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/ivoryriggerwrath/discord-fix-19.9/releases/latest) и скачайте **`.rar`** (предпочтительно)
